...
exists x. exists x0. inversion H17.  split. lia. auto.
apply sub_trans with (B:=A2);auto.
apply sub_trans with (B:=A1);auto. auto.
subst. inversion H10. apply split_nil in H17. inversion H17.
subst. inversion H26. inversion H23. subst.
...
exists x. exists x0. split. lia. auto.
 apply sub_trans with (B:=A2);auto.
apply sub_trans with (B:=A1);auto.
...
inversion H.  contradict H3. auto.
subst. right. exists i0. exists T'. split. lia.
 split. auto. auto.
...
split. lia. inversion H25. auto.
right. inversion H3.  inversion H12.
inversion H18. inversion H24.
exists x. exists x0. exists x1. split. lia. auto.
 apply sub_trans with (B:=A2);auto.
apply sub_trans with (B:=A1);auto.
...
split.
lia. repeat split;auto. inversion H16. auto.
...
split. lia. repeat split;auto. inversion H8.  auto.
...
split. lia. split. apply sub_trans with (B:=x1); auto.
split. subst. auto.
...
clear .  intro. lia.  split. apply sub_trans with (B:=x1); auto.
split. subst. auto.
apply BangSub2;auto. apply SubAreVal in H37.
inversion H37. inversion H33. apply bArrow;auto.
